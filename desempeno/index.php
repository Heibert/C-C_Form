...
<body class="bg-primary container p-5">
	...
	<div class="rounded container p-5 bg-white hidden-content" id='main-container'>
		...
		<div class="text-center" id='calidadTrabajo' hidden>
			<div class="h5">CALIDAD DEL TRABAJO</div>
		</div>
