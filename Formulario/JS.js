...
window.addEventListener("load", function (e) {
    ...
    this.document.getElementById("Guardar").addEventListener("submit", (e) => {
        Promediar(e);
    });
    this.document.getElementById("Siguiente").addEventListener("click", (e) => {
        MostrarS(e);
    });
    this.document.getElementById("anterior").addEventListener("click", (e) => {
        MostrarA(e);
    });
});
...
function Promediar(e) {
    ...
    for (let i = 0; i < CantidadCheck; i++) {
        ...
        if (Respuestas.length == 5) {
            ...
            /* Mostrar el promedio */
            document.getElementById(`Promedio${checkA}`).textContent =
                "PROMEDIO: " + Promedio;
