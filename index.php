...
<body class="bg-primary container p-5">
	<div class="rounded container p-5 bg-white">
		<!-- Encabezado -->
		<p class="text-black-50">Usted esta evaluando a: </p>
		...
		<form class="container" method="post" name="Formulario" id="Guardar" hidden>
			...
			<div id="Pregunta_1" hidden>
					...
					<div class="col-4 text-center">
						<div class="form-floating">
							<select class="form-select" id="floatingSelect" aria-label="Floating label select example"
								required>
								<option selected>Selecione una opcion por favor</option>
				...
				<div class="row">
					<div class="row p-3">Supervisa y corrige el trabajo del equipo, anticipándose ante errores o fallas.
					</div>
					<div class="row-1 d-flex">
						<input checked name="1-1" class="form-check-input" type="radio" id="Encuesta" required
							value="1">
						<div class="ps-3">Insuficiente</div>
					</div>
					<div class="row-1">
						<div class="d-flex">
							<input name="1-1" class="form-check-input" type="radio" id="Encuesta" value="2">
				...
				<div class="row">
					<div class="row p-3">Posee amplios conocimientos del mercado, el negocio, su área y lo comparte con
						...
						equipo.</div>
					<div class="row-1 d-flex">
						<input checked name="1-2" class="form-check-input" type="radio" id="Encuesta" required
							value="1">
						<div class="ps-3">Insuficiente</div>
					</div>
					<div class="row-1 d-flex">
						<input name="1-2" class="form-check-input" type="radio" id="Encuesta" value="2">
				...
				<div class="row">
					...
					<div class="row-1 d-flex">
						<input checked name="1-3" class="form-check-input" type="radio" id="Encuesta" required
							value="1">
						<div class="ps-3">Insuficiente</div>
					</div>
					<div class="row-1 d-flex">
						<input name="1-3" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observación</div>
					</div>
					<div class="row-1 d-flex">
				...
				<div class="row">
					...
					<div class="row-1 d-flex">
						<input checked name="1-4" class="form-check-input" type="radio" id="Encuesta" required
							value="1">
						<div class="ps-3">Insuficiente</div>
					</div>
					<div class="row-1 d-flex">
						<input name="1-4" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observación</div>
					</div>
					<div class="row-1 d-flex">
				...
				<div class="row">
					...
					<div class="row-1 d-flex">
						<input checked name="1-5" class="form-check-input" type="radio" id="Encuesta" required
							value="1">
						<div class="ps-3">Insuficiente</div>
					</div>
					<div class="row-1 d-flex">
						<input name="1-5" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observación</div>
					</div>
					<div class="row-1 d-flex">
				...
				<div class="row">
					<div class="centro" id="Promedio1"><!-- Aqui va el promedio --></div>
				</div>
			</div>
			...
			<div id="Pregunta_2" hidden>
				...
				<div class="row">
					<div class="row p-3">Comparte información relevante con sus colaboradores y con otras áreas de la
						organización.</div>
					<div class="row-1 d-flex">
						<input checked name="2-1" class="form-check-input" type="radio" id="Encuesta" required
							value="1">
						<div class="ps-3">Insuficiente</div>
					</div>
					<div class="row-1 d-flex">
						<input name="2-1" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observación</div>
					</div>
					<div class="row-1 d-flex">
				...
				<div class="row">
					...
					<div class="row-1 d-flex">
						<input name="2-2" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observación</div>
					</div>
					<div class="row-1 d-flex">
						<input checked name="2-2" class="form-check-input" type="radio" id="Encuesta" value="3">
						<div class="ps-3">Bueno</div>
					</div>
					<div class="row-1 d-flex">
				...
				<div class="row">
					...
					<div class="row-1 d-flex">
						<input name="2-3" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observación</div>
					</div>
					<div class="row-1 d-flex">
						<input checked name="2-3" class="form-check-input" type="radio" id="Encuesta" value="3">
						<div class="ps-3">Bueno</div>
					</div>
					<div class="row-1 d-flex">
				...
				<div class="row">
					...
					<div class="row-1 d-flex">
						<input name="2-4" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observación</div>
					</div>
					<div class="row-1 d-flex">
					...
					<div class="row-1 d-flex">
						<input checked name="2-4" class="form-check-input" type="radio" id="Encuesta" value="4">
						<div class="ps-3">Muy bueno</div>
					</div>
					<div class="row-1 d-flex">
				...
				<div class="row">
					...
					<div class="row-1 d-flex">
						<input name="2-5" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observación</div>
					</div>
					<div class="row-1 d-flex">
					...
					<div class="row-1 d-flex">
						<input checked name="2-5" class="form-check-input" type="radio" id="Encuesta" value="4">
						<div class="ps-3">Muy bueno</div>
					</div>
					<div class="row-1 d-flex">
				...
				<div class="row">
					<div class="centro" id="Promedio2"><!-- Aqui va el promedio --></div>
				</div>
			</div>
			...
			<div id="Pregunta_3" hidden>
				...
				<div class="row">
					<div class="row p-3">Monitorea el logro de los objetivos e implementa acciones correctivas.</div>
					<div class="row-1 d-flex">
						<input name="3-1" class="form-check-input" type="radio" id="Encuesta" required value="1">
						<div class="ps-3">Insuficiente</div>
					</div>
					<div class="row-1 d-flex">
						<input name="3-1" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observación</div>
					</div>
					<div class="row-1 d-flex">
						<input checked name="3-1" class="form-check-input" type="radio" id="Encuesta" value="3">
						<div class="ps-3">Bueno</div>
					</div>
					<div class="row-1 d-flex">
				...
				<div class="row">
					...
					<div class="row-1 d-flex">
						<input name="3-2" class="form-check-input" type="radio" id="Encuesta" value="2">
					...
					<div class="row-1 d-flex">
						<input checked name="3-2" class="form-check-input" type="radio" id="Encuesta" value="5">
						<div class="ps-3">Excelente</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="row-1 d-flex">
						<input checked name="3-3" class="form-check-input" type="radio" id="Encuesta" required
							value="1">
						<div class="ps-3">Insuficiente</div>
					</div>
					<div class="row-1 d-flex">
						<input name="3-3" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observacion</div>
					</div>
					<div class="row-1 d-flex">
				...
				<div class="row">
					...
					<div class="row-1 d-flex">
						<input name="3-4" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observacion</div>
					</div>
					<div class="row-1 d-flex">
					...
					<div class="row-1 d-flex">
						<input checked name="3-4" class="form-check-input" type="radio" id="Encuesta" value="4">
						<div class="ps-3">Muy bueno</div>
					</div>
					<div class="row-1 d-flex">
				...
				<div class="row">
					...
					<div class="row-1 d-flex">
						<input name="3-5" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observacion</div>
					</div>
					<div class="row-1 d-flex">
					...
					<div class="row-1 d-flex">
						<input checked name="3-5" class="form-check-input" type="radio" id="Encuesta" value="5">
						<div class="ps-3">Excelente</div>
					</div>
				</div>
				<div class="row">
					<div class="centro" id="Promedio3"><!-- Aqui va el promedio --></div>
				</div>
			</div>
			...
			<div id="Pregunta_4" hidden>
				...
				<div class="row">
					<div class="row p-3">Es paciente y tolerante con sus clientes, aun en situaciones complejas.</div>
					<div class="row-1 d-flex">
						<input name="4-1" class="form-check-input" type="radio" id="Encuesta" required value="1">
						<div class="ps-3">Insuficiente</div>
					</div>
					<div class="row-1 d-flex">
						<input name="4-1" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observacion</div>
					</div>
					<div class="row-1 d-flex">
					...
					<div class="row-1 d-flex">
						<input checked name="4-1" class="form-check-input" type="radio" id="Encuesta" value="5">
						<div class="ps-3">Excelente</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="row-1 d-flex">
						<input name="4-2" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observacion</div>
					</div>
					<div class="row-1 d-flex">
					...
					<div class="row-1 d-flex">
						<input checked name="4-2" class="form-check-input" type="radio" id="Encuesta" value="5">
						<div class="ps-3">Excelente</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="row-1 d-flex">
						<input name="4-3" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observacion</div>
					</div>
					<div class="row-1 d-flex">
					...
					<div class="row-1 d-flex">
						<input checked name="4-3" class="form-check-input" type="radio" id="Encuesta" value="5">
						<div class="ps-3">Excelente</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="row-1 d-flex">
						<input name="4-4" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observacion</div>
					</div>
					<div class="row-1 d-flex">
						<input checked name="4-4" class="form-check-input" type="radio" id="Encuesta" value="3">
						<div class="ps-3">Bueno</div>
					</div>
					<div class="row-1 d-flex">
				...
				<div class="row">
					...
					<div class="row-1 d-flex">
						<input name="4-5" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observacion</div>
					</div>
					<div class="row-1 d-flex">
					...
					<div class="row-1 d-flex">
						<input checked name="4-5" class="form-check-input" type="radio" id="Encuesta" value="5">
						<div class="ps-3">Excelente</div>
					</div>
				</div>
				<div class="row">
					<div class="centro" id="Promedio4"><!-- Aqui va el promedio --></div>
				</div>
			</div>
			...
			<div id="Pregunta_5" hidden>
				...
				<div class="row">
					<div class="row p-3">Es participativo, aporta ideas y estimula a su gente para que actúe de la misma
						forma.
					</div>
					<div class="row-1 d-flex">
					...
					<div class="row-1 d-flex">
						<input name="5-1" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observacion</div>
					</div>
					<div class="row-1 d-flex">
					...
					<div class="row-1 d-flex">
						<input checked name="5-1" class="form-check-input" type="radio" id="Encuesta" value="5">
						<div class="ps-3">Excelente</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="row-1 d-flex">
						<input checked name="5-2" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observacion</div>
					</div>
					<div class="row-1 d-flex">
				...
				<div class="row">
					...
					<div class="row-1 d-flex">
						<input name="5-3" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observacion</div>
					</div>
					<div class="row-1 d-flex">
						<input checked name="5-3" class="form-check-input" type="radio" id="Encuesta" value="3">
						<div class="ps-3">Bueno</div>
					</div>
					<div class="row-1 d-flex">
				...
				<div class="row">
					<div class="row p-3">Le gusta estar informado y aprender para aplicar estos conocimientos si tiene
						oportunidad.</div>
					<div class="row-1 d-flex">
						<input checked name="5-4" class="form-check-input" type="radio" id="Encuesta" required
							value="1">
						<div class="ps-3">Insuficiente</div>
					</div>
					<div class="row-1 d-flex">
						<input name="5-4" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observacion</div>
					</div>
					<div class="row-1 d-flex">
				...
				<div class="row">
					...
					<div class="row-1 d-flex">
						<input name="5-5" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observacion</div>
					</div>
					<div class="row-1 d-flex">
						<input checked name="5-5" class="form-check-input" type="radio" id="Encuesta" value="3">
						<div class="ps-3">Bueno</div>
					</div>
					<div class="row-1 d-flex">
				...
				<div class="row">
					<div class="centro" id="Promedio5"><!-- Aqui va el promedio --></div>
				</div>
			</div>
			...
			<div id="Pregunta_6" hidden>
				...
				<div class="row">
					...
					<div class="row-1 d-flex">
						<input name="6-1" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observacion</div>
					</div>
					<div class="row-1 d-flex">
					...
					<div class="row-1 d-flex">
						<input checked name="6-1" class="form-check-input" type="radio" id="Encuesta" value="5">
						<div class="ps-3">Excelente</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="row-1 d-flex">
						<input name="6-2" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observacion</div>
					</div>
					<div class="row-1 d-flex">
						<input checked name="6-2" class="form-check-input" type="radio" id="Encuesta" value="3">
						<div class="ps-3">Bueno</div>
					</div>
					<div class="row-1 d-flex">
				...
				<div class="row">
					...
					<div class="row-1 d-flex">
						<input name="6-3" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observacion</div>
					</div>
					<div class="row-1 d-flex">
						<input checked name="6-3" class="form-check-input" type="radio" id="Encuesta" value="3">
						<div class="ps-3">Bueno</div>
					</div>
					<div class="row-1 d-flex">
				...
				<div class="row">
					...
					<div class="row-1 d-flex">
						<input name="6-4" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observacion</div>
					</div>
					<div class="row-1 d-flex">
					...
					<div class="row-1 d-flex">
						<input checked name="6-4" class="form-check-input" type="radio" id="Encuesta" value="5">
						<div class="ps-3">Excelente</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="row-1 d-flex">
						<input name="6-5" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observacion</div>
					</div>
					<div class="row-1 d-flex">
					...
					<div class="row-1 d-flex">
						<input checked name="6-5" class="form-check-input" type="radio" id="Encuesta" value="5">
						<div class="ps-3">Excelente</div>
					</div>
				</div>
				<div class="row">
					<div class="centro" id="Promedio6"><!-- Aqui va el promedio --></div>
				</div>
			</div>
			...
			<div id="Pregunta_7" hidden>
				...
				<div class="row">
					...
					<div class="row-1 d-flex">
						<input name="7-1" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observacion</div>
					</div>
					<div class="row-1 d-flex">
					...
					<div class="row-1 d-flex">
						<input checked name="7-1" class="form-check-input" type="radio" id="Encuesta" value="5">
						<div class="ps-3">Excelente</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="row-1 d-flex">
						<input name="7-2" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observacion</div>
					</div>
					<div class="row-1 d-flex">
						<input checked name="7-2" class="form-check-input" type="radio" id="Encuesta" value="3">
						<div class="ps-3">Bueno</div>
					</div>
					<div class="row-1 d-flex">
				...
				<div class="row">
					...
					<div class="row-1 d-flex">
						<input checked name="7-3" class="form-check-input" type="radio" id="Encuesta" required
							value="1">
						<div class="ps-3">Insuficiente</div>
					</div>
					<div class="row-1 d-flex">
						<input name="7-3" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observacion</div>
					</div>
					<div class="row-1 d-flex">
				...
				<div class="row">
					...
					<div class="row-1 d-flex">
						<input name="7-4" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observacion</div>
					</div>
					<div class="row-1 d-flex">
					...
					<div class="row-1 d-flex">
						<input checked name="7-4" class="form-check-input" type="radio" id="Encuesta" value="4">
						<div class="ps-3">Muy bueno</div>
					</div>
					<div class="row-1 d-flex">
				...
				<div class="row">
					...
					<div class="row-1 d-flex">
						<input name="7-5" class="form-check-input" type="radio" id="Encuesta" value="2">
						<div class="ps-3">En observacion</div>
					</div>
					<div class="row-1 d-flex">
					...
					<div class="row-1 d-flex">
						<input checked name="7-5" class="form-check-input" type="radio" id="Encuesta" value="4">
						<div class="ps-3">Muy bueno</div>
					</div>
					<div class="row-1 d-flex">
				...
				<div class="row">
					<div class="centro" id="Promedio7"><!-- Aqui va el promedio --></div>
				</div>
			</div>
			<div id="Pregunta_8" hidden>
				...
				<div class="d-grid gap-2">
					<button type="button" id="NuevaFila" class="btn btn-secondary"><i
							class="fa-solid fa-chevron-down iconArrow"></i></button><br>
				</div>

				<div class="p-3">
					<h5 class="text-center">COMPROMISOS DE MEJORAMIENTO</h5>
					<div class="form-floating">
						<textarea class="form-control" placeholder="Leave a comment here" style="height: 250px"
			...
			<div class="row p-3">
				<div class="col">
					<button id="anterior" hidden class="btn btn-secondary btn-lg"><i
							class="fa-solid fa-arrow-left"></i></button>
				</div>
				<div class="col">
					<div class="text-end">
						<button id="Siguiente" class="btn btn-secondary btn-lg"><i
